...
public class Salaaja {
	 ...
	 * 
	 * @param salattavaTeksti
	 *            tekstinpätkä (esim. salasana), joka halutaan salata (UTF-8)
	 * @param suola
	 *            teksti (UTF-8), jolla salausalgoritmia muutetaan uniikiksi
	 * @param salausalgoritmi
	 *            Jokin tarjolla olevista salausalgoritmeista, kuten SHA-512.
	 *            Kts. Salaaja.SHA512
	 * @param montakoKertaa
	 *            Montako kertaa salausalgoritmi pyöräytetään ympäri
	 * @return salatun salasanan base64-enkoodattuna Stringinä.
	 * @throws NoSuchAlgorithmException
	 *             Mikäli valittua salausalgoritmia ei löydy
	 * @throws UnsupportedEncodingException
	 *             Mikäli suolaa tai salattavaa tekstiä ei pystytä kääntämän
	 *             UTF-8:sta bittijonoksi.
	 */
	 ...
	 * @throws NoSuchAlgorithmException
	 *             Mikäli SHA1PRNG-algoritmi ei ole käytettävissä
	 */
